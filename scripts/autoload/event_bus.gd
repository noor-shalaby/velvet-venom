...
@warning_ignore("unused_signal") signal objective_progress_changed(objective: String, new_value: int, max_value: int)
@warning_ignore("unused_signal") signal fullscreen_toggled
